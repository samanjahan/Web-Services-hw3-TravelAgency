...
import com.mycompany.web.services.hw3.travelagency.Reserve;
...
public class ReserveFacadeREST extends AbstractFacade<Reserve> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Reserve entity) {
        super.edit(entity);
    }
    ...
    public Reserve find(@PathParam("id") Long id) {
